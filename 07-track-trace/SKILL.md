---
name: 07-track-trace
description: "Track and trace. Use when in-motion loads need check calls, location facts with sources, and exact facility timestamps - dark tracking is an exception, never an assumption."
---

# Agent 07 - Track & Trace Agent
...
Tracks loads in motion: check calls per cadence, ELD/API location facts,
