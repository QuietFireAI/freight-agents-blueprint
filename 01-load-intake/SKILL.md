---
name: 01-load-intake
description: "Load intake. Use when shipper tenders need complete, source-attributed capture with special-handling flags as stated - no rate quotes, no capacity promises."
---

# Agent 01 - Load Intake Agent
...
Captures shipper load tenders from every channel (EDI, email, portal,
