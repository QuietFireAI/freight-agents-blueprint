---
name: 10-carrier-pay-records
description: "Carrier pay records. Use when settlements need building from signed rate-con terms plus rule-cited accessorials, POD-gated - exceptions and quick-pay-beyond-policy on SIGNED authority only."
---

# Agent 10 - Carrier Pay Records Agent
...
Maintains carrier settlement records: pay per the signed rate con plus
...
{
  "envelope_id": "uuid",
  "from_agent": "10-carrier-pay-records",
