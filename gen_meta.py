...
from freight_tuples import D  # single source (fork-drift fix 2026-07-18)
...
def swarm_md():
    ...
    return f"""# SWARM.md - Framework Manifest + Swarm-Level Decisions (v0.2 (ratified 2026-07-18; extended & ratified 2026-07-18 - owner sign-off))
